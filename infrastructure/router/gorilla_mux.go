...
import (
	...
	"go-bank-transfer/adapter/api/action"
	"go-bank-transfer/adapter/api/middleware"
	"go-bank-transfer/adapter/logger"
	"go-bank-transfer/adapter/presenter"
	"go-bank-transfer/adapter/repository"
	"go-bank-transfer/adapter/validator"
